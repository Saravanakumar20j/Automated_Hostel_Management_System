<?php
    ...
    $query="INSERT into warden(firstName,lastName,gender,block,blockid,contactNo,econtact,username,email,password,gname,grelation,gcontact,address,city,pincode,paddress,pcity,ppincode) values(?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)";
    $stmt = $mysqli->prepare($query);
    $rc=$stmt->bind_param('ssssiiisssssississi',$fname,$lname,$gender,$block,$blockid,$contactno,$emcntno,$username,$emailid,$password,$gurname,$gurrelation,$gurcntno,$caddress,$ccity,$cpincode,$paddress,$pcity,$ppincode);
    $stmt->execute();
