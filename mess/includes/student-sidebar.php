...
<nav class="sidebar-nav">
    ...
    <ul id="sidebarnav">
		...
		<li class="sidebar-item"> <a class="sidebar-link sidebar-link" href="register-complaint.php"
        aria-expanded="false">
		<span class="hide-menu">🕵️‍♀️ Complaint</span></a></li>
		
	
		
		<li class="sidebar-item"> <a class="sidebar-link sidebar-link" href="log-activity.php"
        aria-expanded="false"><span
        class="hide-menu">🍱 Food menu</span></a></li>
		
		<li class="sidebar-item"> <a class="sidebar-link sidebar-link" href="log-activity.php"
        aria-expanded="false"><span
        class="hide-menu">🚶🏼‍♂️ vaccate & Leave</span></a></li>
