<?php
    ...
    if(isset($_POST['submit'])){
        ...
        $query="INSERT into  registration(roomno,seater,block,blockid,feespm,foodstatus,stayfrom,duration,course,regno,firstName,middleName,lastName,gender,contactno,emailid,egycontactno,guardianName,guardianRelation,guardianContactno,corresAddress,corresCIty,corresPincode,pmntAddress,pmntCity,pmntPincode,department) values(?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)";
        $stmt = $mysqli->prepare($query);
        $rc=$stmt->bind_param('iisiississssssisissississis',$roomno,$seater,$block,$blockid,$feespm,$foodstatus,$stayfrom,$duration,$course,$regno,$fname,$mname,$lname,$gender,$contactno,$emailid,$emcntno,$gurname,$gurrelation,$gurcntno,$caddress,$ccity,$cpincode,$paddress,$pcity,$ppincode,$department);
        $stmt->execute();
            ...
            <form method="POST">
                ...
                <div class="row">
                    ...
                    <div class="col-sm-12 col-md-6 col-lg-4">
                        ...
                        <div class="card-body">
                                ...
                                <div class="custom-control custom-radio">
                                    <input type="radio" id="customRadio1" value="North mess" name="foodstatus"
                                        class="custom-control-input">
                                    <label class="custom-control-label" for="customRadio1">North mess <code>Extra RS40 per day</code></label>
                                </div>
                                <div class="custom-control custom-radio">
                                    <input type="radio" id="customRadio2" value="South mess" name="foodstatus"
                                        class="custom-control-input" checked>
                                    <label class="custom-control-label" for="customRadio2">South mess <code>Extra RS60 per day</code></label>
                                </div>
                    ...
                    <div class="col-sm-12 col-md-6 col-lg-4">
                        <div class="card">
                            <div class="card-body">
                                <h4 class="card-title">Fees Per Day</h4>
                                    <div class="form-group">
                                    ...
                                    <div class="form-group mb-4">
                                        <select class="custom-select mr-sm-2" id="department" name="department">
                                            ...
                                            <?php $query ="SELECT * FROM department";
                                                ...
                                                {
                                            ?>
                                            <option value="<?php echo $row->Department;?>"><?php echo $row->Department;?>&nbsp;&nbsp;(<?php echo $row->Clg;?>)</option>
                                            <?php } ?>
                                        </select>
                                    </div>
