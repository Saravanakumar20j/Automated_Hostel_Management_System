...
<nav class="sidebar-nav">
    ...
    <ul id="sidebarnav">
		...
		<li class="sidebar-item"> <a class="sidebar-link sidebar-link" href="takeAttendance.php"
        aria-expanded="false"><i class="fas fa-user-plus"></i><span
        class="hide-menu">Take Attendance</span></a></li>
		
		
		
		<li class="sidebar-item"> <a class="sidebar-link sidebar-link" href="manage-wardan.php"
        aria-expanded="false"><i class="fas fa-user-circle""></i><span
        class="hide-menu">Manage Warden</span></a></li>
		
		
		<li class="sidebar-item"> <a class="sidebar-link sidebar-link" href="createSessionTerm.php"
        aria-expanded="false"><i class="fas fa-user-plus"></i><span
        class="hide-menu">Create Session and term</span></a></li>
		
		
		<li class="sidebar-item"> <a class="sidebar-link sidebar-link" href="closed-complaint.php"
        aria-expanded="false"><i class="fas fa-user-plus"></i><span
        class="hide-menu">Complaint</span></a></li>
		
		
		
			<li class="sidebar-item"> <a class="sidebar-link sidebar-link" href="add-messmanager.php"
        aria-expanded="false"><i class="fas fa-user-plus"></i><span
        class="hide-menu">Mess Manager</span></a></li>
