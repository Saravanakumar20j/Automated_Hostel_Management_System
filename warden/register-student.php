<?php
    ...
    $query="INSERT into userRegistration(regNo,firstName,middleName,lastName,gender,department,contactNo,email,password) values(?,?,?,?,?,?,?,?,?)";
    $stmt = $mysqli->prepare($query);
    $rc=$stmt->bind_param('ssssssiss',$regno,$fname,$mname,$lname,$gender,$department,$contactno,$emailid,$password);
    $stmt->execute();
