<?php
    ...
    $query="INSERT into messmanager(firstName,lastName,gender,block,blockid,contactNo,econtact,email,password,gname,grelation,gcontact,address,city,pincode,paddress,pcity,ppincode) values(?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)";
        ...
        <div class="page-wrapper">
            ...
            <div class="page-breadcrumb">
                <div class="row">
                    ...
                    <h4 class="page-title text-truncate text-dark font-weight-medium mb-1">Mess Manager Registration Form</h4>
