<?php
	...
	$query = "SELECT registration.blockid
    FROM warden
...
/*	$sql="SELECT sessionterm FROM warden where isActive ='1'";
	
	
	$rwws = $mysqli->prepare($sql);
	
$sessionTermId = $rwws['id'];

$dateTaken = date("Y-m-d");

$qurty=mysqli_query($con,"select * from attendance  where blockid = '$_SESSION[id]' and dateTimeTaken='$dateTaken'");
$count = mysqli_num_rows($qurty);

if($count == 0){
    // Insert new attendance records if they don't exist for the current date.
    $qus=mysqli_query($conn,"select * from registration  where blockid = '$_SESSION[id]'");
    while ($ros = $qus->fetch_assoc()) {
        $qquery=mysqli_query($conn,"insert into attendance(regno,firstName,department,block,sessionTermId,status,dateTimeTaken) 
        value('$ros[regno]','$ros[firstName]','$ros[department]','$ros[block]','$sessionTermId','0','$dateTaken')");
    }
} */
                    ...
                    <tbody>
					 ...
					 <?php	
                                        ...
                                        <td><?php echo $row->regno;?></td>
										 ...
										 <td>  <input name='check[]' type='checkbox' value=".$rows['regno']." class='form-control'> 
										 </td>
										 </tr>
