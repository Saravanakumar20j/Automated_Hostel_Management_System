<?php
    session_start();
    include('includes1/dbconn.php');
    if(isset($_POST['login']))
    {
    $email=$_POST['email'];
    $password=$_POST['password'];
    $password = md5($password);
    $stmt=$mysqli->prepare("SELECT email,password,id FROM wardan WHERE email=? and password=? ");
            ...
            <div class="auth-box row">
                ...
                <div class="col-lg-5 col-md-7 bg-white">
                    <div class="p-3">
                        ...
                        <h2 class="mt-3 text-center">Wardan Login</h2>
